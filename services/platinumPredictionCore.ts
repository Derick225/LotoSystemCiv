import { PlatinumResult, DrawResult, SymbioticContext, PlatinumScenario, Prediction, PlatinumUserOptions, ForensicReport } from '../types';
...
export async function generatePlatinumPredictionCore(
    ...
    // useNexusStore est un hook Zustand, on utilise getState() directement
