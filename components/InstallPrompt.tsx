...
export const InstallPrompt: React.FC = () => {
  ...
  const handleInstallClick = async () => {
    ...
    try {
      ...
      logError(
        new AppError("Erreur d'installation PWA", "PWA_INSTALL_ERROR", "low", {
          error: err,
        }),
      );
    }
        ...
        <div className="flex gap-5 items-start">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1 font-medium leading-relaxed">
              Accédez au moteur prédictif en mode natif : performances
              maximales, interface immersive et absence de barre d'adresse.
            </p>
          </div>
        </div>
          ...
          {isIOS ? (
            <div className="bg-slate-800/50 rounded-2xl p-4 border border-white/5 space-y-3">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300">
                <span className="w-6 h-6 flex items-center justify-center bg-slate-700 rounded-full font-bold shrink-0">
                  1
                </span>
                <span>
                  Appuyez sur l'icône{" "}
                  <span className="font-bold text-white inline-flex items-center gap-1 bg-white/10 px-2 py-0.5 rounded ml-1">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-4 border border-white/5 space-y-3">
              ...
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>
                  Ouvrez le menu{" "}
                  <span className="font-bold text-white inline-flex items-center gap-1 bg-white/10 px-2 py-0.5 rounded ml-1">
                    <MoreVertical size={12} /> d'options
                  </span>
                </span>
              </div>
              <div className="flex items-center gap-3 text-xs text-slate-300">
                ...
                <span>
                  Choisissez{" "}
                  <span className="font-black text-white">"Installer"</span> ou{" "}
