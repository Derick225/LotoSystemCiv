...
export const OracleLiveAssistant: React.FC<OracleLiveAssistantProps> = ({ drawName }) => {
    ...
    const handleToolCall = async (toolCall: any) => {
        ...
        for (const fc of toolCall.functionCalls) {
            ...
            if (fc.name === 'inspectNumber') {
                ...
                window.dispatchEvent(new CustomEvent('NAVIGATE_TO_MODULE', { detail: { mainTab: tab, subTab } }));
    ...
    return (
        <div className="fixed bottom-28 right-6 z-[80] md:bottom-8 flex flex-col items-end gap-4 pointer-events-none">
            ...
            {isActive && (
                <div className="bg-slate-950/90 backdrop-blur-2xl border border-indigo-500/50 p-6 rounded-[2.5rem] shadow-2xl w-72 animate-slide-up pointer-events-auto relative overflow-hidden">
                    ...
                    <div className="h-32 bg-black/50 rounded-3xl overflow-hidden border border-white/5 flex items-center justify-center relative">
                        ...
                        <div className="absolute bottom-2 text-[9px] font-mono font-bold text-slate-500 uppercase tracking-widest">
                    ...
                    <div className="mt-4 flex justify-between items-center px-2">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-bold text-slate-400 uppercase">Canal Sécurisé</span>
                        </div>
                        <div className="flex items-center gap-2 text-indigo-400/50">
                            <Command size={12} />
                            <span className="text-[8px] font-black">CMD</span>
                        </div>
                    </div>
                </div>
            )}
