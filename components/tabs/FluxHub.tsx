...
export const FluxHub: React.FC<{ history: DrawResult[] }> = ({ history }) => {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12 w-full max-w-7xl mx-auto">
        {/* Controls Bar */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 bg-white dark:bg-slate-800 p-4 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-700 sticky top-32 z-30 mx-auto w-full">
            ...
            <div className="flex flex-wrap gap-2 w-full sm:w-auto justify-center sm:justify-end">
                ...
                <div className="relative flex-1 sm:w-48 group min-w-[150px]">
                    <input 
                        type="text" 
        ...
        {/* CALENDAR VIEW */}
        {viewMode === 'calendar' && (
            <div className="animate-fade-in mx-auto w-full flex justify-center">
