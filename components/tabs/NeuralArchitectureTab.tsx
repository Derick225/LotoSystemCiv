        ...
        while (path.size < 5 && steps < 20) { // Safety break
            ...
            if (neighbors.length > 0) {
                ...
                if (availableHighEnergy.length > 0) {
                    nextId = availableHighEnergy[Math.floor(prng.next() * availableHighEnergy.length)].number;
                } else {
            ...
            <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex gap-4">
                    <div className="bg-black/30 px-4 py-2 rounded-xl border border-white/5 text-center">
                        <div className="text-xs font-black text-slate-500 uppercase">Nœuds Actifs</div>
                        <div className="text-lg font-black text-white">{nodes.filter(n => n.centrality > 1).length}</div>
                    </div>
                    <div className="bg-black/30 px-4 py-2 rounded-xl border border-white/5 text-center">
                        <div className="text-xs font-black text-slate-500 uppercase">Densité</div>
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="mt-4 flex justify-center gap-4">
                                                <div className="text-center">
                                                    <div className="text-xs font-black text-slate-500 uppercase">Masse</div>
                                                    <div className="text-xl font-black text-white">{selectedNodeData.centrality.toFixed(1)}</div>
                                                </div>
                                                <div className="text-center">
                                                    <div className="text-xs font-black text-slate-500 uppercase">Tribu</div>
