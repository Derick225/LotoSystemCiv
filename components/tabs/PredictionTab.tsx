          ...
          <div className="relative z-10 flex flex-col items-center mt-12 w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-md mx-auto mb-8">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-4 rounded-xl text-sm font-semibold uppercase tracking-wider transition-colors shadow-sm"
              >
                <Activity size={18} /> Inférence{" "}
                {networkState.isOffline ? "Locale" : "Simple"}
              </button>
              <button
                onClick={runMonteCarlo}
                className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-black dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100 text-white px-6 py-4 rounded-xl text-sm font-semibold uppercase tracking-wider transition-colors shadow-sm"
              >
                <RefreshCw size={18} /> Monte Carlo
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 md:p-8 border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <button
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors rounded-xl font-semibold text-xs uppercase tracking-wider disabled:opacity-50"
            >
              {isComputing ? (
        ...
        {!isComputing && lastPrediction && (
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl sm:rounded-[2rem] p-4 sm:p-8 border border-slate-200/60 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none flex flex-col items-center justify-center relative overflow-hidden text-center">
                <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-8 w-full text-left flex items-center gap-2">
