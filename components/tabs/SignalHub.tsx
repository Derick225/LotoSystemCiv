...
export const SignalHub: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'cluster', label: 'Markov & Clusters', icon: Box, color: 'text-cyan-500' },
        { id: 'academy', label: 'Académie', icon: BookOpen, color: 'text-fuchsia-500' }
    ];
                        ...
                        <LocalErrorBoundary key={activeSubTab}>
                            <Suspense fallback={
                                <div className="py-20 flex flex-col items-center justify-center gap-4">
                                    ...
                                    <p className="text-slate-500 font-bold uppercase text-xs tracking-widest">Calcul du module...</p>
                                </div>
                            }>
