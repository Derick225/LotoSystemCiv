        ...
        try {
            ...
            for (let i = 0; i < baseTickets.length; i += CHUNK_SIZE) {
                ...
                const processedChunk = chunk.map(t => {
                    ...
                    if (useHarmonicFilter && avgEnergy < 30) return null; 
                    ...
                    if (odds === 2 || odds === 3) nexusScore += 20; 
                ...
                <>
                    ...
                    <div className="bg-slate-900 text-white p-8 rounded-[3.5rem] shadow-2xl border border-slate-800 relative overflow-hidden group">
                        ...
                        <div className="relative z-10 grid lg:grid-cols-3 gap-12">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {acoPaths.slice(0, 3).map((path, i) => (
                                            ...
                                            >
                                                <div className="w-6 h-6 rounded-full bg-indigo-500/20 text-indigo-400 flex items-center justify-center text-[9px] font-black">#{i+1}</div>
                                                <div className="flex gap-1">
                                                    {path.numbers.map(n => (
                                                        <span key={n} className="w-5 h-5 rounded-md bg-black/40 flex items-center justify-center text-[9px] font-bold text-white">{n}</span>
                                                    ))}
                                                </div>
                                            </button>
                                        ))}
                            ...
                            {/* Console Logs */}
                            <div className="bg-black/40 p-6 rounded-[2.5rem] border border-white/5 flex flex-col justify-between h-full min-h-[200px]">
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className="text-[9px] font-bold text-indigo-500 bg-indigo-50 dark:bg-indigo-900/30 px-2 py-1 rounded-lg">
                                    ...
                                    <div className="flex gap-4">
                                        <div className="flex-1 space-y-2">
                                            ...
                                            <div className="flex bg-slate-100 dark:bg-slate-900 p-1 rounded-xl">
                                                <button onClick={() => setSystemType('full')} className={`flex-1 py-2 text-[9px] font-bold rounded-lg transition ${systemType === 'full' ? 'bg-white dark:bg-slate-700 shadow text-indigo-600 dark:text-white' : 'text-slate-500'}`}>Intégral</button>
                                                <button onClick={() => setSystemType('reduced')} className={`flex-1 py-2 text-[9px] font-bold rounded-lg transition ${systemType === 'reduced' ? 'bg-white dark:bg-slate-700 shadow text-indigo-600 dark:text-white' : 'text-slate-500'}`}>Réduit</button>
                                            </div>
                                        </div>
                                        {systemType === 'reduced' && (
                                            <div className="flex-1 space-y-2">
                                    ...
                                    >
                                        <div className="flex justify-between items-center relative z-10">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex gap-1">
                                                    {t.numbers.map(n => (
                                                        <span key={n} className="w-7 h-7 rounded-lg bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 flex items-center justify-center text-[10px] font-bold text-slate-700 dark:text-slate-300 group-hover:bg-white dark:group-hover:bg-slate-800 transition-colors">
                                                            {n}
                                                        </span>
                                                    ))}
                                                </div>
                                        ...
                                        {/* Quick Stats */}
                                        <div className="flex gap-4 mt-3 pl-11 text-[9px] font-mono text-slate-400">
                                            <span>∑ {t.sum}</span>
                                            <span>AC {t.ac}</span>
                                            <span>{t.parity}</span>
                                        </div>
