        ...
        <div className="space-y-8 animate-fade-in pb-20 w-full overflow-hidden">
            ...
            <div className="flex justify-center -my-4 relative z-10">
                <div className="bg-slate-900 p-2 rounded-full border border-slate-800 shadow-xl">
                    <ArrowDown className={`text-slate-500 ${isFusing ? 'animate-bounce' : ''}`} size={24} />
                </div>
            </div>
            ...
            <AnimatePresence>
                {fusionResult && (
                    <motion.div 
                        ...
                        className="bg-white dark:bg-slate-800 p-8 rounded-[3.5rem] shadow-2xl border-2 border-indigo-500/20 relative overflow-hidden"
                    >
                        <div className="absolute top-0 right-0 p-10 opacity-5"><Layers size={140}/></div>
                        
                        <div className="relative z-10 flex flex-col items-center gap-8">
                            <div className="text-center">
                                <div className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-500 mb-4">Résultat de la Fusion</div>
                            ...
                            <div className="w-full max-w-lg space-y-6">
                                <div className="flex justify-between items-center text-[10px] font-black uppercase text-slate-400 tracking-widest">
                                    ...
                                    <span className="text-indigo-500">{fusionResult.confidence}%</span>
                                </div>
                                ...
                                <button 
                                    onClick={handleSave}
                                    className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl flex items-center justify-center gap-2 transition-all active:scale-95"
                                >
