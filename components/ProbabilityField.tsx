                ...
                {[
                    ...
                    <div key={item.type} className="p-2 md:p-3 bg-white rounded-xl md:rounded-2xl border border-slate-200 flex items-center gap-2 md:gap-3 shadow-sm">
                        ...
                        <div className="min-w-0 overflow-hidden">
                            <div className="text-[10px] md:text-xs font-black text-slate-800 uppercase truncate">{item.type}</div>
                            <div className="text-[10px] md:text-[10px] text-slate-500 uppercase truncate">{item.desc}</div>
                        </div>
                    </div>
                ))}
            </div>
