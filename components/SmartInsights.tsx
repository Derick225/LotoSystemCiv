...
import { ArrowRight, AlertTriangle, Lightbulb, Zap, Clock, Activity, BarChart2 } from 'lucide-react';
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex justify-between items-start mb-2">
                                ...
                                <span className={`text-xs font-black px-2 py-1 rounded-lg border uppercase tracking-widest ${theme.iconBg} bg-opacity-20 border-opacity-20`}>
