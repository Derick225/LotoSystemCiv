...
export const ToastProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const getStyles = (type: ToastType) => {
      switch(type) {
          case 'success': return 'border-emerald-500/50 bg-slate-900/90 text-white shadow-[0_0_15px_rgba(16,185,129,0.2)] border';
          case 'error': return 'border-rose-500/50 bg-slate-900/90 text-white shadow-[0_0_15px_rgba(244,63,94,0.2)] border';
          default: return 'border-indigo-500/50 bg-slate-900/90 text-white shadow-[0_0_15px_rgba(99,102,241,0.2)] border';
      }
  };
