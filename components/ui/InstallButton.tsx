...
export const InstallButton: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const isStandaloneMode = window.matchMedia('(display-mode: standalone)').matches || !!(navigator as typeof navigator & { standalone?: boolean }).standalone;
  ...
  const handleInstallClick = async () => {
    ...
    if (!promptToUse) {
      alert("L'installation n'est pas encore prête ou votre navigateur ne la supporte pas directement.");
      return;
    }
