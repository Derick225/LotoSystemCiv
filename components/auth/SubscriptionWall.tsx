...
export const SubscriptionWall: React.FC<SubscriptionWallProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] bg-nexus-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/80 backdrop-blur-2xl border border-slate-700/50 p-8 rounded-3xl shadow-2xl relative z-10 animate-scale-in text-center">
        ...
        <p className="text-slate-400 text-sm font-medium mb-8 leading-relaxed">
          Votre période d'essai de 30 jours est terminée. Pour continuer à
          bénéficier de la puissance de l'Oracle Nexus, renouvelez votre accès.
        </p>
        ...
        <div className="bg-gradient-to-br from-indigo-900/50 to-slate-900 rounded-2xl p-6 border border-indigo-500/30 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 text-left">
            <div className="text-[10px] font-black uppercase text-indigo-300 tracking-widest mb-1">
              Abonnement Premium
            </div>
            ...
            <ul className="mt-4 space-y-2 text-xs text-slate-300 font-medium">
              <li className="flex items-center gap-2">
                <ShieldCheck size={12} className="text-emerald-400" /> Accès
                illimité aux Prédictions IA
              </li>
              <li className="flex items-center gap-2">
                <ShieldCheck size={12} className="text-emerald-400" /> Analyses
                Forensiques & Spectrales
              </li>
              <li className="flex items-center gap-2">
                <ShieldCheck size={12} className="text-emerald-400" /> Support
                Prioritaire
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-3">
          ...
          >
            {loading && selectedProvider === "ORANGE" ? (
        ...
        <button
          onClick={onLogout}
          className="mt-8 text-xs font-bold text-slate-500 hover:text-white flex items-center justify-center gap-2 transition-colors"
        >
