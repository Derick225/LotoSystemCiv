...
export const BootSequence: React.FC<BootSequenceProps> = ({ onComplete }) => {
    ...
    const bootSteps = [
        { text: "Initialisation du Noyau LotoPro v12.0...", delay: 600, icon: <Cpu size={16}/> },
        { text: "Chargement des modules heuristiques...", delay: 1000, icon: <Binary size={16}/> },
        { text: "Synchronisation des tenseurs neuronaux...", delay: 1400, icon: <Wifi size={16}/> },
        ...
        { text: "SYSTÈME EN LIGNE.", delay: 3800, icon: <div className="w-2 h-2 bg-emerald-500 rounded-full shadow-[0_0_10px_#10b981]"/> }
    ];
