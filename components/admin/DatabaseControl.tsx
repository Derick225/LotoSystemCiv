...
import { Database, HardDrive, Trash2, Server, Activity, Copy, RefreshCw, Save, AlertCircle } from 'lucide-react';
...
export const DatabaseControl: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            {/* Status Header */}
            <div className={`p-8 rounded-2xl border shadow-2xl relative overflow-hidden flex flex-col md:flex-row justify-between items-center gap-6 ${connectionStatus === 'error' ? 'bg-rose-950 border-rose-800' : 'bg-slate-900 border-slate-800'}`}>
