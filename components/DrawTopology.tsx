...
export const DrawTopology: React.FC<DrawTopologyProps> = ({
  winners,
  machine = [],
  size = "sm",
}) => {
          ...
          return (
            <div
              ...
              className={`
                                ...
                                ${
                                  isWinner && isMachine
                                    ? "bg-white ring-4 ring-yellow-400 z-30 scale-125"
                                    : isWinner
                                      ? `${colorClass} shadow-lg z-20 scale-110 ring-1 ring-white/20`
                                      : isMachine
                                        ? "bg-slate-700/50 border border-dashed border-slate-500"
                                        : "bg-slate-800/40"
                                }
                            `}
            ></div>
